...
{
	public $TitreDocument = "Liste des variables" ;
	public $Titre = "Liste des variables" ;
	...
	protected function DetermineTablPrinc()
	{
		...
		$this->TablPrinc->FournisseurDonnees->RequeteSelection = "rpapp_variable" ;
		...
		$this->TablPrinc->InsereLienAction($acts, 'javascript:ouvreUrlModal(\'?appelleScript=modifVar&nom=${nom}\')', 'Modifier') ;
	}
...
<a class="btn btn-primary" href="javascript:ouvreUrlModal(\'?appelleScript=ajoutVar\') ;">Ajouter</a>
</div>
</div>
<br>' ;
		return $ctn ;
